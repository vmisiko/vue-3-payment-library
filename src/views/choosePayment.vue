<template>
  <div class="flex-center">
    ...
    <div class="card">
      ...
      <div class="">
        <div class="mt-4 text-caption-1 d-flex pa-3 selected-border" >
            ...
            <div class="">
              ...
              <input type="radio" :value="visa"  v-model="picked" >
             </div>
        </div>

        <div class="mt-4 text-caption-1 d-flex pa-3 ">
      ...
      <span class="link mt-5"> + Add payment option</span>
